...
export default function RegisterPage() {
  ...
  const handleRegister = (e: React.FormEvent) => {
    e.preventDefault();
    setLoading(true);
    // Prepared for Phase 3 next-auth registration
    setTimeout(() => {
      setLoading(false);
  ...
  return (
    <Card className="p-8 shadow-xl border-zinc-200/90 dark:border-zinc-800">
      <CardHeader className="space-y-1 text-center pb-6">
        ...
        <CardDescription>
          Get started with your 14-day full feature trial. No credit card needed.
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <Button variant="outline" className="w-full gap-2 text-xs" type="button">
        ...
        <form onSubmit={handleRegister} className="space-y-3.5">
          ...
          <div className="pt-2 text-[11px] text-zinc-500 space-y-1">
            <div className="flex items-center gap-1.5">
              ...
              <span>Includes 1,000 complimentary AI conversation credits</span>
            </div>
            <div className="flex items-center gap-1.5">
              <CheckCircle2 className="h-3.5 w-3.5 text-emerald-500" />
              <span>Full Meta WhatsApp Cloud API sandbox access</span>
            </div>
          </div>
